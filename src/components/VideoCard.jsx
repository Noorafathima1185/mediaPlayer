  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
          <iframe width="100%" height="392" src={`${displayVideo?.url}?autoplay=1`} title="Armadham | Aavesham | Jithu Madhavan |Fahadh Faasil | Sushin Shyam | Vinayak| Nazriya| Anwar Rasheed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </Modal.Body>
        </Modal>
    </>
  )
