...
function View({addStatus, setDragStatus}) {
  ...
  const videoDrop = async(e)=>{
    const {videoId, categoryId} = JSON.parse(e.dataTransfer.getData("dataShare"))
  ...
  return (
    <Row className='w-100 ms-2' droppable onDragOver={(e)=>DragOver(e)} onDrop={(e)=>videoDrop(e)}>
      ...
      :
      <p className='text-warning fs-4 mt-3'>No video yet uploaded...</p>
      }
